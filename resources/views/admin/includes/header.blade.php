<header class="main-header-top hidden-print">
    <a href="{{route('admin.dashboard')}}" class="logo"><img class="img-fluid able-logo" src="{{asset('public/images/icon/ww_white.png') }}" alt="Theme-logo" width="200"></a>
                ...
                <li class="dropdown notification-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="bell-notification">
                            <a href="javascript:;" class="media">
                                <span class="media-left media-icon">
                                    <img class="img-circle" src="{{asset('public/admin/assets/images/avatar-1.png') }}" alt="User Image">
                                </span>
                        ...
                        <li class="bell-notification">
                            <a href="javascript:;" class="media">
                                <span class="media-left media-icon">
                                    <img class="img-circle" src="{{asset('public/admin/assets/images/avatar-2.png') }}" alt="User Image">
                                </span>
                        ...
                        <li class="bell-notification">
                            <a href="javascript:;" class="media"><span class="media-left media-icon">
                                <img class="img-circle" src="{{asset('public/admin/assets/images/avatar-3.png') }}" alt="User Image">
                            </span>
            ...
            <div id="morphsearch" class="morphsearch">
                ...
                <div class="morphsearch-content">
                    ...
                    <div class="dummy-column">
                        <h2>Popular</h2>
                        <a class="dummy-media-object" href="#!">
                            <img src="{{asset('public/admin/assets/images/avatar-1.png') }}" alt="PagePreloadingEffect"/>
                            <h3>Page Preloading Effect</h3>
                        </a>

                        <a class="dummy-media-object" href="#!">
                            <img src="{{asset('public/admin/assets/images/avatar-1.png') }}" alt="DraggableDualViewSlideshow"/>
                    ...
                    <div class="dummy-column">
                        <h2>Recent</h2>
                        <a class="dummy-media-object" href="#!">
                            <img src="{{asset('public/admin/assets/images/avatar-1.png') }}" alt="TooltipStylesInspiration"/>
                            <h3>Tooltip Styles Inspiration</h3>
                        </a>
                        <a class="dummy-media-object" href="#!">
                            <img src="{{asset('public/admin/assets/images/avatar-1.png') }}" alt="NotificationStyles"/>
