            ...
            <div class="col-lg-8 col-md-12 grid-item">
                <div class="card">
                    <div class="row">
                        ...
                        </div> <!-- col-lg-5 p-l-0 climacon-right end--> 
                    </div>

                </div><!-- card end-->
            </div> <!-- col-lg-8 col-md-12 grid-item end-->
        </div> 
        <!-- 3-1-block end --> 
        <!-- 2-1 block start -->
        <div class="row">
                        ...
                        <div class="table-responsive">
                            <table class="table m-b-0 photo-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th>
                                            <img class="img-fluid img-circle" src="{{asset('admin/assets/images/avatar-4.png') }}" alt="User">
                                        </th>
                                    ...
                                    <tr>
                                        <th>
                                            <img class="img-fluid img-circle" src="{{asset('admin/assets/images/avatar-1.png') }}" alt="User">
                                        </th>
                                    ...
                                    <tr>
                                        <th>
                                            <img class="img-fluid img-circle" src="{{asset('admin/assets/images/avatar-3.png') }}" alt="User">
                                        </th>
                                        <td>Contract with belife Company
                                            <p><i class="icofont icofont-clock-time"></i>Created 20.10.2016</p>
                                        </td>
