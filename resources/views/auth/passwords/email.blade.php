...
<head>
    ...
    <title>{{ config('app.name', 'Workshire') }} - Forgot Password</title>
        ...
        <div class="row">
            ...
            <div class="col-md-9 register-right">
                <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="profile-tab" href="{{ route('login') }}" role="tab" aria-controls="profile" aria-selected="false">Login</a>
                    </li>
                </ul>
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="login" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        {{ Form::open(array('route' => 'password.email', 'aria-label' => 'Forgot Password')) }}
