			                    ...
			                    <table class="table table-bordered">
			                    	...
			                    	<tr>
			                    		...
			                    		<td>
			                    			...
			                    			href="{{ route('verify_user', [ 'token' => $user->verifyUser->token ]) }}">Verify email</a>
			                    		</td>
			                    	</tr>
			                    	<tr>
			                    		<td colspan="2"> 
                                            <p class="font-italic">If you’re having trouble clicking the "Verify Account" button, copy and paste the URL below into your web browser: 
                                                <a href="{{ route('verify_user', [ 'token' => $user->verifyUser->token ]) }}">
                                                    {{ route('verify_user', [ 'token' => $user->verifyUser->token ]) }}
                                                </a>
                                            </p>
			                    		</td>
			                    	</tr> 
