                    ...
                    <table style="padding: 10px;font-size:14px; width:100%;">
                        ...
                        <tr>
                            <td style="padding:10px;font-size:14px; width:100%;">
                                ...
                                <p>
                                    You have 1 applicant applied that your job posting.<br/>
                                ...
                                <table class="table table-bordered">
                                    <tr>
                                        <td>
                                            Search your potential candidate through our various listings from more than 10, 000 candidates in Workshire.
                                            <a class="btn btn-primary btn-sm d-block" href="{{ route('employer.main') }}">
                                            	<i class="fa fa-globe" aria-hidden="true" style="font-size:1em;"></i> 
                                            	EXPLORE OUR SITES NOW
                                            </a>
                                        </td>
                                    </tr>
                                </table>
