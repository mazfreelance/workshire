                    ...
                    <table style="padding: 10px;font-size:14px; width:100%;">
                        ...
                        <tr>
                            <td style="padding:10px;font-size:14px; width:100%;">
                                ...
                                <p>
                                    You have 1 notification for your Workshire&#39;s account. 
                                </p>
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            href="{{ route('verify_user', [ 'token' => $user->verifyUser->token ]) }}">Verify account</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <p class="font-italic">If you’re having trouble clicking the "Verify Account" button, copy and paste the URL below into your web browser: 
                                                <a href="{{ route('employer.verify', ['token' => $user->verifyUser->token]) }}">
                                                    {{ route('employer.verify', ['token' => $user->verifyUser->token]) }}
                                                </a>
                                            </p>
                                        </td>
                                    </tr> 
