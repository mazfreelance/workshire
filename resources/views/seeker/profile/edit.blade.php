...
<main class="py-0">  
	...
	<div class="loading"><i class="fa fa-spinner fa-spin fa-2x fa-tw"></i><br><span>Loading</span></div>
		                ...
		                <div class="tab-pane active">
		                    <form role="form" method="post" action="{{route('seeker.profile.update')}}" id="editprofile">
							    ...
							    <div class="form-group row">
							        ...
							        <div class="col-lg-9">
							            <input class="form-control" type="text" value="{{old('name') !== null ? old('name'):$seek->seeker_name}}" name="name" id="name"/> 
